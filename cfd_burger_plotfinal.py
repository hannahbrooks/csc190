...
def evolve(u, v, dx, dy, dt, nozzle_u, nozzle_v, nx, ny, steps):
    for i in range(steps):
        (u, v) = equation_of_motion(u, v, dx, dy, dt)
...
(final_u, final_v) = evolve(initial_u, initial_v, dx, dy, dt, nozzle_u, nozzle_v, nx, ny, nt)
